...
public class TableroTest {
	...
	@Test
	public void test03AgregoAliadoEnSectorAliadoYSeColocaEnEsaPosicion() {
		Tablero tablero = new Tablero();
		Jugador jugador = new Jugador();
		Entidad soldado1 = new Aliado(new Soldado(jugador));
		Entidad soldado2 = new Aliado(new Soldado(jugador));
		int fila = 5;
		int columna = 10;
		tablero.colocar(soldado1, fila, columna);
		assertThrows(CasilleroOcupadoException.class, () -> {
			tablero.colocar(soldado2, fila, columna);
		});		
	}

	@Test
	public void test04AgregoEnemigoEnSectorEnemigoYSeColocaEnEsaPosicion() {
		Tablero tablero = new Tablero();
		Jugador jugador = new Jugador();
		Entidad soldado1 = new Enemigo(new Soldado(jugador));
		Entidad soldado2 = new Enemigo(new Soldado(jugador));
		int fila = 15;
		int columna = 10;
		tablero.colocar(soldado1, fila, columna);
		assertThrows(CasilleroOcupadoException.class, () -> {
